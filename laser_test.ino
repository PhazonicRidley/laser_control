...
void setup() {
  ...
  x_servo.write(90); // this will most likely need to be updated
  y_servo.write(90);
}
...
void drawPoint(float z_distance) {
 
  float x_angle = atan(x_pos/z_distance);
  float y_angle = atan(y_pos/z_distance);
